...
inline constexpr KeyMapping mappingsNonLinear[] = {
...
inline constexpr KeyMapping mappingsLinear[] = {{KEY_Q, "Q"},
                                                {KEY_W, "W"},
                                                {KEY_E, "E"},
                                                {KEY_R, "R"},
                                                {KEY_T, "T"},
...
inline constexpr Rectangle rects[] = {{startX + size * 0.5f, startY + size * 0.5f, size, size},
